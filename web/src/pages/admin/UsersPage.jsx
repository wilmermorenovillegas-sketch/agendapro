...
// - Tabla con lista de usuarios del tenant
// - Boton resetear contrasena (con generador automatico)
// - Boton editar datos (nombre, apellido, telefono, rol)
...
export default function UsersPage() {
  ...
  const [modalMode, setModalMode] = useState('edit'); // 'edit' o 'password'
  ...
  // Toggle activo/inactivo (directo, sin modal)
  ...
  return (
    <div className="p-6 max-w-7xl mx-auto" style={{ fontFamily: 'DM Sans, sans-serif' }}>
                    ...
                    <td className="px-4 py-3 text-right">
                      <div className="flex items-center justify-end gap-2">
                        <button
                          ...
                          className="px-3 py-1 rounded-md text-xs font-semibold text-teal-700 border border-teal-200 hover:bg-teal-50 transition"
                        >
                          Editar
                        </button>
                        <button
                          onClick={() => openPasswordModal(u)}
                          className="px-3 py-1 rounded-md text-xs font-semibold text-slate-700 border border-slate-200 hover:bg-slate-50 transition"
                        >
                          Resetear
                        </button>
                      </div>
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 rounded-lg border border-slate-200 focus:border-[#0F766E] focus:outline-none text-sm"
                  />
                </div>
                <div>
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-3 py-2 rounded-lg border border-slate-200 focus:border-[#0F766E] focus:outline-none text-sm disabled:bg-slate-50"
                  >
              ...
              <div>
                ...
                <div className="flex gap-2">
                  <input
                    ...
                    className="flex-1 px-3 py-2 rounded-lg border border-slate-200 focus:border-[#0F766E] focus:outline-none text-sm font-mono"
                  />
                  <button
                    onClick={() => setSelectedUser({ ...selectedUser, newPassword: generateTempPassword() })}
                    className="px-3 py-2 rounded-lg bg-slate-100 hover:bg-slate-200 text-xs font-semibold text-slate-700 transition"
                  >
                    Generar
                  </button>
                </div>
      ...
      {/* Toast */}
      {toast && (
        <div className={`fixed bottom-6 right-6 px-4 py-3 rounded-lg shadow-lg text-sm font-semibold z-50 ${
          toast.type === 'success'
